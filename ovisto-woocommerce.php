...
final class OvistoWoo {
     ...
     * @param $args
     */
    function action_woocommerce_before_template_part( $template_name, $template_path, $located, $args ) {

        if($template_name != null && $template_name === "checkout/thankyou.php"){
			
            $plugin_path  = $this->plugin_path() . '/woocommerce/';
            $template = "checkout/thankyou_prepend.php";
